...
- **Design direction**: The app should return to a cozy, playful visual identity with warm colors, paper-like tactility, and a clearly centered document surface. Avoid an overly rounded aesthetic, and keep the print layout space-efficient rather than decorative. Secondary controls should stay out of the way near the top edges rather than competing with the main form/template content. (F-008)
