...
- **Design direction**: The app should return to a cozy, playful visual identity with warm colors, paper-like tactility, and a clearly centered document surface. Secondary controls should stay out of the way near the top edges rather than competing with the main form/template content. (F-008)
